...
class FeelslikeInfo {
  ...
  FeelslikeInfo({required this.feels_like});

  factory FeelslikeInfo.fromJson(Map<String, dynamic> json) {
    final feelsLike = json['feels_like'];
    return FeelslikeInfo(feels_like: feelsLike);
  }
}
...
class WeatherResponse {
  ...
  final FeelslikeInfo feelslikeInfo;
  ...
  factory WeatherResponse.fromJson(Map<String, dynamic> json) {
    ...
    final feelslikeInfo = FeelslikeInfo.fromJson(feelslikeInfoJson);
